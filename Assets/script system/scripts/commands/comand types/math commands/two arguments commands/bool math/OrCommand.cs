...
public class OrCommand : TwoArgumentsMathCommand
{
    ...
    public OrCommand(out Value resultValue, Value firstArgument, Value secondArgument) :
    ...
    public override bool InvokeCommand()
    {
        ...
        throw new System.Exception("or command unsuported type of arguments");
    }
}