...
public class SubtractCommand : TwoArgumentsMathCommand
{
    ...
    public SubtractCommand(out Value resultValue, Value firstArgument, Value secondArgument) :
        base(MathCommandType.SubtractCommandType, firstArgument, secondArgument)
    {
